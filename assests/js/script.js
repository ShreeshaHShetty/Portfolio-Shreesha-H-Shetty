...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Full-Stack development", "Machine Learning", "Flutter development"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
// <!-- emailjs to mail contact form data -->
 $("#contact-form").submit(function (event) {
    ...
    event.preventDefault();
    emailjs.init("flcbD-RvlC3sPBMNR");
    console.log("form submitted");
    emailjs.sendForm('service_0d8l7s8', 'template_6h9lkqc', '#contact-form')
